		...
		*/
		...
		function Move(){
			...
			if($BG5a.hasClass("inview")){ // Intro Him - Frank Stockton
				...
				$BG5b.css({'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 5), .45, 0), 'height': panelHeight}); // russ
				$BG5c.css({'backgroundPosition': CalculateShift('middle', 'static', pos, (panelHeight * 5),  .6, 0), 'height': panelHeight}); // microphone
			...
			if($BG11a.hasClass("inview")){ // Waiting - Josh Cochran
				...
				$BG11c.css({'height': panelHeight}); // frame
